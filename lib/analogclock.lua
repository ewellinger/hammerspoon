...
-- analogclock.lua
-- Analog Clock for your desktop

local AnalogClock = {
    -- Trigger update to the clock every second
    tickRate = 1,
...
function AnalogClock:showAnalogClock()
    if not bgcirle then
        ...
        imagedisp = hs.drawing.image(imagerect,"/Users/ewellinger/.hammerspoon/assets/watchbg.png")
        ...
        bgcirle:setStrokeColor(self.seccolor)
        ...
        mincirle:setStrokeColor(self.tofilledcolor)
        ...
        hourcirle:setStrokeColor(self.tofilledcolor)
        ...
        sechand:setFillColor(self.secfillcolor)
        sechand:setStrokeWidth(1)
        sechand:setStrokeColor(self.seccolor)
        ...
        minhand1:setStrokeColor(self.mincolor)
        ...
        minhand2:setStrokeColor(self.mincolor)
        ...
        minhand3:setStrokeColor(self.mincolor)
        ...
        hourhand1:setStrokeColor(self.hourcolor)
        ...
        hourhand2:setStrokeColor(self.hourcolor)
        ...
        hourhand3:setStrokeColor(self.hourcolor)
        ...
        if clocktimer == nil then
            clocktimer = hs.timer.doEvery(self.tickRate,function() self:updateClock() end)
        else
            clocktimer:start()
        end
    else
...
function AnalogClock:updateClock()
